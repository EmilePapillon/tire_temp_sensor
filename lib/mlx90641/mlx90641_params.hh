...
/// @brief Slots in the broken-pixel list: one per tolerated pixel, plus one that
/// stays empty unless the EEPROM reports more broken pixels than can be corrected.
