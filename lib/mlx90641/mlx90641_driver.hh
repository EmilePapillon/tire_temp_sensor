...
public:
    ...
    /// So is a part that ships with up to max_broken_pixels broken pixels, which
    /// the datasheet allows: the warning names them and calculate_temps()
    /// interpolates them away. More than that fails as CalibrationExtractionFailed.
